...
//		teste.teste2();
	...
	private void teste1(){
		...
		d1[4][5] = true;
		d1[4][6] = true;
		Funcionario f1 = new Funcionario("A", d1, horasDeTrabalho, true);
		...
		d2[4][3] = true;
		d2[4][5] = true;
		Funcionario f2 = new Funcionario("B", d2, horasDeTrabalho, true);
		...
		d3[4][0] = true;
		d3[4][4] = true;
		Funcionario f3 = new Funcionario("C", d3, horasDeTrabalho, true);
		funcionarios.add(f1);
		funcionarios.add(f2);
		funcionarios.add(f3);
		Agenda agenda = new Agenda(funcionarios, 1, horarios);
		Organizador org = new Organizador(agenda, 1, horarios, 1000, 6005000);
	}
	...
	private void teste2() {
		...
		Organizador org = new Organizador(agenda, dias, horarios, 5000, 500000000);
