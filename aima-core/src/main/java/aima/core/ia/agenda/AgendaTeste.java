...
//		teste.teste1();
	...
	private void teste1(){
		...
		Organizador org = new Organizador(agenda, dias, horarios, 2, 100, 1500000);
	}
	...
	private void teste2() {
		...
		Funcionario f1 = new Funcionario("Alice", h1);
		...
		Funcionario f2 = new Funcionario("Bob", h2);
		...
		Funcionario f3 = new Funcionario("Charlie", h3);
		...
		Funcionario f4 = new Funcionario("David", h4);
		...
		Funcionario f5 = new Funcionario("Eve", h5);
		funcionarios.add(f1);
		funcionarios.add(f2);
		funcionarios.add(f3);
		funcionarios.add(f4);
		funcionarios.add(f5);
		Agenda agenda = new Agenda(funcionarios, dias, horarios);
		Organizador org = new Organizador(agenda, dias, horarios, 3, 1000, 50000000);
